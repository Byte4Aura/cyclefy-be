/*
  ...
  - You are about to drop the `recyclelocationimage` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `recyclelocationimage` DROP FOREIGN KEY `RecycleLocationImage_recycle_location_id_fkey`;

-- DropTable
DROP TABLE `recyclelocationimage`;
